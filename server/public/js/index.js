...
/***/ (function(module, exports, __webpack_require__) {
	...
	//import './class/对象扩展'
	//import './class/Symbol'
	//import './class/set-map数据结构'
	//import './class/map-set与数组和对象的比较'
	//import './class/Proxy和Reflect'
	//import './class/类与对象'
	...
	//import './class/es6模块化'
	//import {A,test,Hello} from './class/es6模块化'
	//import c from './class/es6模块化'
	...
	var Lottery = function (_mix) {
	    ...
	    _createClass(Lottery, [{
	        ...
	        value: function initEvent() {
	            var self = this;
	            (0, _jquery2.default)('#play').on('click', 'li', self.chanePlayNav.bind(self));
	...
	var Base = function () {
	    ...
	    _createClass(Base, [{
	        ...
	        value: function assistHandle(e) {
	            ...
	            (0, _jquery2.default)('.boll-list .btn-boll').removeClass('btn-boll-active');
	            if (index === 0) {
	                (0, _jquery2.default)('.bill-list .btn-boll').addClass('btn-boll-active');
	            }
	            if (index === 1) {
...
/***/ (function(module, exports) {
	...
	var Calculate = function () {
	    ...
	    _createClass(Calculate, [{
	        ...
	        //computeCount 计算柱数
	        //{number} active 当前选中的号码
	        //{string} play_name 当前的玩法标实
	        value: function computeCount(active, pay_name) {
	            var count = 0;
